...
def upgrade() -> None:
    ...
    op.add_column('association', sa.Column('president', sa.Uuid(), nullable=False))
    op.add_column('association', sa.Column('secretary', sa.Uuid(), nullable=False))
    op.add_column('association', sa.Column('assignor', sa.Uuid(), nullable=False))
    op.add_column('association', sa.Column('registrar', sa.Uuid(), nullable=False))
